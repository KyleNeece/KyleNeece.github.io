**Things to Note:**
- Very much a sandbox, liter multiple quest points throughout 
...
**Note:** This is where the majority of DND is played. If you want the most classic DND feel, this is for you
...
Elysium is home to creatures of unfettered kindness and a refuge for planar travelers seeking a safe life and beauty.
haven. The plane's bucolic landscapes glimmer with The River Oceanus originates in the lowest layer of Elysium, Thalasia, and flows through the plane's layers before cascading onward to the Beastlands.
...
Characters can use the Etherealness spell to enter the Border Ethereal. The Plane Shift spell allows transport to the Border Ethereal or the Deep Ethe-real, but unless the intended destination is a specific location or a teleportation circle, the point of arrival could be anywhere on the plane.
...
Modrons are the primary inhabitants of Mecha-nus and maintain its intricate clockworks. The plane is also home to the creator of the modrons: a godlike being called Primus, whose realm is called Regulus.
...
- Main Objectives 
	- Find the Sword of History 
	- How to find the Sword of History, here is a quest line: 
		- Hotel is located in Arcadia 
		- Will be shown around the Hotel in order to use its facilities 
			- Most importantly, will be shown to the teleportation circle. Will also be given deices to activate teleportation circles around the universe via Hoo Dini 
		- Party will have to choose a location to start 
