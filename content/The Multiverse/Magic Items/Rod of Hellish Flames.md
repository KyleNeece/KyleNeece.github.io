...
**Searing Rebuke.** You can cast the [Hellish Rebuke](http://dnd5e.wikidot.com/spell:hellish-rebuke) spell as a 4th-level spell (save DC 16) from the rod. Once you use the rod to cast the spell, the rod can’t cast the spell again until the next dawn.
