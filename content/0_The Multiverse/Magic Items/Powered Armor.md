...
- Fire arm-mounted laser: _Ranged Weapon Attack_: +8 to hit, range 120 feet, one target. _Hit_: 2d6 radiant damage (1 charge or 5 hit points).
...
You can also find more upgrades for the suit, either pulling from the [Powered Armor](https://dnd5e.wikidot.com/wondrous-items:powered-armor) page or create your own features (DM's discreation)
