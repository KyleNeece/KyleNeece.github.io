...
- **Description**: The user can disrupt or sever the narrative flow of events, creating "plot holes" that invalidate or erase parts of the story. This ability allows the user to:
    ...
    - Render abilities created or borrowed by **Author's Skill** ineffective by "writing them out" of the story's context.
    - Create paradoxes or gaps in logic to confuse and weaken opponents.

---

### Rock-Paper-Scissors Relationship:

1. **Logic Slash** > **Author's Skill**:  
