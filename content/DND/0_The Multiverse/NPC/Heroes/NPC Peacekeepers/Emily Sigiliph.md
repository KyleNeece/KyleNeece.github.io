...
traits:
  ...
  - name: Legendary Indomitable 
    desc: Reroll and grant a  +16 bonus to a save, 3x/long rest
  ...
  - name: Heavy Armor Master
    desc: While you are wearing heavy armor, bludgeoning, piercing, and slashing damage that you take from nonmagical attacks is reduced by 3.
  - name: Sentinel
    desc: When you hit a creature with an opportunity attack, the creature's speed becomes 0 for the rest of the turn. Creatures provoke opportunity attacks from you even if they take the Disengage action before leaving your reach.
actions:
  - name: Multiattack
    desc: Emiliy Sigiliph can make 3 attacks
  - name: His Eminence 
