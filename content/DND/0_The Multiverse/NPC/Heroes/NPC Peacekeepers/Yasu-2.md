...
##### Brief Summary 
Yasu-2 is a Autognome Peace Cleric, a Sentient creation of [[Jotor Sparklefen]], and S-Rank [[Peacekeeper Force]]
...
###### Twin Prodigies Arc
Yasu-2 arrived to Peacekeeper high and made an effort to go up to [[Jackson Felwinter]] and [[Azriel Darkstar]], greeting them warmly and sitting with them during the opening assembly. During the house selection ceremony, Yasu-2 was sorted into House Equinox. He later also became friends with [[Emily Sigiliph]], [[Aria Hassan]], and [[Olivia Birdsong]]. 
...
###### Panmnesia Arc
 ...
 > 
 > Before the Panmnesia spell hit, Yasu-2 made sure to activate the contingency that its creator implanted in it. Yasu would only lose parts of his memory. He linked his conscious with [[Kabe-34]] for the purpose of sharing the fragmented parts of memories from each that would help piece together the past timeline events that conspired and their importance. At somepoint, Ludwig secretly dug into the twos minds, and began his research on the past. 
###### Recruitment
...
traits:
  ...
  - name: Prepared Caster
    desc: Prepare 22 spells for adventuring days
  - name: Elemental Adept Fire
    desc: Fire damaging spells ignore resistances. In addition, you can treat any 1 on a damage die as a 2 for fire spells
actions:
  - name: Channel Divinity Turn undead
    desc: As an action, you present your holy symbol and speak a prayer censuring the undead. Each undead that can see or hear you within 30 feet of you must make a Wisdom saving throw. If the creature fails its saving throw, it is turned for 1 minute or until it takes any damage. A turned creature must spend its turns trying to move as far away from you as it can, and it can't willingly move to a space within 30 feet of you. It also can't take reactions. For its action, it can use only the Dash action or try to escape from an effect that prevents it from moving. If there's nowhere to move, the creature can use the Dodge action. Moreover, when an undead fails its saving throw against your Turn Undead feature, the creature is instantly destroyed if its challenge rating is at or below CR3. Save DC = 19 2x/rest
