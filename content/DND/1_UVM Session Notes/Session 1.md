...
**Opening**: The PCs start out on in front of a portal on Sigil, which will lead them to the Peacekeeper Home Base. 
- The scene in front of them is a large staircase with pillars on each side and nothing around the ground they stand on but the overview of the City of Sigil. 
- The scene shifts to the Giant circle archway with a perimeter Fence that leads to an open flat area, with: 
	- Barracks
	- Perimeter Fence 
	- Watchtower 
	- Armory 
	- Training Facilities
	- Vehicle Docks and Pools
	- Mess Hall
	- Higher Ranking Officer Quarters 
	- Power Plants 
	- Hospital
	- Housing 
	- And many more larger medieval futuristic high fantasy buildings

- The 8 will walk to a large obelisk, where each of the peacekeepers will place their hands on
- After, the party will go to the training ground warehouse, where Ludwig along with some sort of magical device will be waiting for them
- The Recruits will be asked to wear special skin tight suits that morph to their body
- The Recruits will then wait for further instructions, and will be teleported into a simulation ran by illusionary magic


**Notes for the session**
- Met Ludwig 
- Trial: Exploration completed 
...
- Jaloop has kept the party together 
- Akanos is still becoming close with the group 
- Equalibriam knows about Aeris 
- Aeris is boys with Monty 
- Otto is close with Monty
- Each gained 100 gp 
