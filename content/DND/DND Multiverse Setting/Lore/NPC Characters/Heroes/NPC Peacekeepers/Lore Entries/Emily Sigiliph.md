...
![[Emily Sigiliph.png]]
##### Personality 
Emily Sigiliph is loyal, tactical, and disciplined but perfectionist and over-critical at the same time. Emily enjoys combat but not to extremes, she gets excited by not "hard on" excited by it. While Emily is disciplined, she is not afraid to play dirty in combat, as she believes that in a fight for life or death you have to use every tactic and strategy you got in order to win. However, she draws the line with giving up your close comrades in order to win. While she isn't extremely close with her brother, he is still her brother so she always makes sure to give him tough sibling love 
...
###### Twin Prodigies Arc
Emily's parents being accomplished military personnel were able to enroll Emily into the academy. Before settling down, she surveyed the room, to see who looked strong so she could pick a rival. In the crowd she found [[(WORK IN PROGRESS) Jackson Felwinter]] and [[Azriel Darkstar]], who through her analyzation were radiating immense strength for their age. She joined them, [[Aria Hassan]], Yasu-2 and [[Olivia Birdsong]]. She introduced herself and quickly become acquaintances. Emily was sorted into House Apex
...
In the Battle-Madness Challenge, Emily made it to the final four, facing off against Jackson Felwinter. The two were almost equal in pure weapon to weapon combat, with Emily actually putting Jackson on the defense, however, it was Jackson's heritage combined with his careful study of magic that ultimately defeated her
...
cr: 17
traits:
  - name: Battlemaster Maneuvers (d10) 11x/rest
    desc: Sweeping Attack, Commanding Presence, Disarming Attack, Quick Toss, Manuvering Attack, Parry, Riposte, Preision Attack, Pushing Attack, Trip Attack, Bait and Switch, Tacitcal Assessment
  - name: Great Weapon Master and Sharpshooter
    desc: -5 to add +10 to damage, on kill bonus action attack
  - name: Action Surge
    desc: Twice per rest, can take an additional action
  - name: Legendary Indomitable 
    desc: Reroll and grant a  +18 bonus to a save, 3x/long rest
  - name: Enhanced Second Wind
    desc: Can use to heal or add to a failed skill check. Can also move half speed no attack of opportunity when used. 1x/rest, all/long rest   
...
actions:
  - name: Multiattack
    desc: Emiliy Sigiliph make 3 attacks
  - name: His Eminence 
    desc: "Melee Weapon Attack: +14 to hit, reach 5 ft., one target. Hit: 2d6+9 slashing"
  - name: Her Monarchy 
    desc: "Ranged Weapon Attack: +13 to hit, reach 10 ft., one target. Hit: 2d6+9 piercing"
  - name: Immobilizing Impalement 
...
bonus_actions:
  - name: Craft/Drink/Apply Brew
    desc: Drink a poiton from the mystic vial of random potions
  - name: Unarmed Strike or Grapple
    desc: "Melee Weapon Attack: +11 to hit, reach 5 ft., one target. Hit: 1d10+7 bludgeoning"
  - name: Cunning Action
    desc: Emiliy Sigliliph can dash, disengage or hide as a bonus action
  - name: Awakened Power
